...
export class Index {
  ...
  objectsByURI: { [uri: URI]: IndexEntry<any> }
      ...
      if (evaluatedValue) {
        return {
          ...
          context: {
            ...
            objectType: parentValue.context.objectType,
            jsonPointerFromObject: `${parentValue.context.jsonPointerFromObject}${remainingPointer}`,
      ...
      if ('$ref' in parentValue.value) {
        ...
        return {
          ...
          context: {
            ...
            baseURI: parentURI,
            jsonPointerFromBaseURI: remainingPointer,
            objectType: followedParentValue.context.objectType,
            jsonPointerFromObject: `${followedParentValue.context.jsonPointerFromObject}${remainingPointer}`,
